...
border=0>
  ...
  <TBODY>
  <TR>
    <TH colSpan=8 height=24>【用户列表】<a href="include/user/userQuery.jsp">点击查询用户</a> </TH>
   </TR>
     <TR>
 ...
 <div><h3>没有相关信息！</h3></div> 
  ...
  <s:a href="UserAction!deleteUser.action?user.userId=%{#listUsers.userId}" onclick="return confirm('您确定要删除本用户吗?')">删除</s:a></TD>
    <TD class=forumrowhighlight  height=24 align="center"><s:a href="UserAction!upUser.action?user.userId=%{#listUsers.userId}">修改</s:a></TD>
  </TR>
  </s:iterator></s:else>
