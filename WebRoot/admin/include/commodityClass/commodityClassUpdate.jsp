...
border=0>
  <TBODY>
  <TR>
    <TH colSpan=2 height=24 >【修改商品种类名称】</TH>
  </TR>
  <TR>
    <TD class=forumrow width="30%" height=24><div align="right">商品种类编号：</div></TD>
    <TD class=forumrowhighlight width="70%"   height=24>
      <input type="text" name="commodityClass.commodityClassId" id="id" value="${sessionScope.commodityClassById.commodityClassId}" readonly="readonly"></TD></TR>
  <TR>
  <TR>
    <TD class=forumrow width="30%" height=24><div align="right">商品种类名称：</div></TD>
  <TD class=forumrowhighlight width="70%"   height=24>
  <input type="text" name="commodityClass.commodityClassName" id="name" value="${sessionScope.commodityClassById.commodityClassName}"></TD></TR>
  <TR>
