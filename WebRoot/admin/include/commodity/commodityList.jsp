...
border=0>
  <TBODY>
  <TR>
    <TH colSpan=10 height=24>【商品列表】<a href="CommodityAction!adCommodity.action">点击添加商品</a></TH>
   </TR>
     <TR>
  ...
  <s:a href="CommodityAction!deleteCommodity.action?commodity.commodityId=%{#listCommoditys.commodityId}" onclick="return confirm('您确定要删除本商品吗?')">删除</s:a></TD>
    <TD class=forumrowhighlight  height=24 align="center"><s:a href="CommodityAction!upCommodityById.action?commodity.commodityId=%{#listCommoditys.commodityId}">修改</s:a></TD>
  </TR>
  </s:iterator>
