...
border=0>
  <TBODY>
  <TR>
    <TH colSpan=2 height=24>【商品种类列表】<s:a href="include/commodityClass/commodityClassAdd.jsp">点击添加商品种类</s:a> </TH> </TR>
  <TR>
  ...
  <TD class=forumrowhighlight width="40%" 
      ...
      <TD class=forumrowhighlight width="20%" 
      height=24><div align="center">修改</div></TD>
  </TR>
  ...
  <s:a href="CommodityClassAction!deleteCommodityClass.action?commodityClass.commodityClassId=%{#listCommodityClasses.commodityClassId}" onclick="return confirm('您确定要删除本商品种类吗?')">删除</s:a></TD>
    <TD class=forumrowhighlight  height=24 align="center"><s:a href="CommodityClassAction!upCommodityClass.action?commodityClass.commodityClassId=%{#listCommodityClasses.commodityClassId}">修改</s:a></TD>
  </TR>
  </s:iterator>
